                                ...
                                children: [
                                  ...
                                  Builder(
                                    builder: (context) {
                                      ...
                                      return Row(
                                        mainAxisSize: MainAxisSize.max,
                                        children: List.generate(kin.length,
                                            (kinIndex) {
                                            ...
                                            onTap: () async {
                                              ...
                                              await showModalBottomSheet(
                                                ...
                                                builder: (context) {
                                                  ...
                                                  () => _model.modelAddImage =
                                                      value));

                                              _shouldSetState = true;
                                              if (_model.modelAddImage !=
                                                  null) {
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      var _shouldSetState = false;
                                      if (_model.useThumbnailCategorie ==
                                          null) {
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(
                                          SnackBar(
